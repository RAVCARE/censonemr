<?php /* Smarty version 2.6.33, created on 2022-03-24 03:34:30
         compiled from /home/censonemr/public_html/openemr/templates/document_categories/general_list.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'xlj', '/home/censonemr/public_html/openemr/templates/document_categories/general_list.html', 17, false),array('function', 'xlt', '/home/censonemr/public_html/openemr/templates/document_categories/general_list.html', 23, false),array('modifier', 'text', '/home/censonemr/public_html/openemr/templates/document_categories/general_list.html', 34, false),array('modifier', 'attr', '/home/censonemr/public_html/openemr/templates/document_categories/general_list.html', 41, false),)), $this); ?>
<?php echo '
 <style>
<!--
.treeMenuDefault {
...
<table>
	...
	<tr>
		...
		<?php endif; ?>
		<?php if (( isset ( $this->_tpl_vars['add_node'] ) && $this->_tpl_vars['add_node'] == true ) || ( isset ( $this->_tpl_vars['edit_node'] ) && $this->_tpl_vars['edit_node'] == true )): ?>
		<td width="25"></td>
		<td valign="top">
    <?php if (isset ( $this->_tpl_vars['add_node'] ) && $this->_tpl_vars['add_node'] == true): ?>
...
&nbsp;</td>
        <td><input type="text" name="name" value="<?php if (isset ( $this->_tpl_vars['NAME'] )): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['NAME'])) ? $this->_run_mod_handler('attr', true, $_tmp) : attr($_tmp)); ?>
<?php endif; ?>" onKeyDown="PreventIt(event)" /></td>
      </tr>
      <tr>
